...
//   });
  ...
  // SENDS SYNTH CHAIN TO OUPUT
  synth5.chain(autoFilter5, gainNode5);
  //
...
// SENDS SYNTH CHAIN TO OUPUT
synth9.chain(feedbackDelay9, gainNode9);


const synth10 = new Tone.AMSynth().connect(feedbackDelay10);
...
// SENDS SYNTH CHAIN TO OUPUT
synth13.chain(chorus, reverb, gainNode13);
