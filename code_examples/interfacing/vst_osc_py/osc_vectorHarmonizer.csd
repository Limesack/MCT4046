<Cabbage>
form caption("Vector Harmonizer"), size(450, 440), pluginID("vhro"), gioRefresh(50)
;image bounds(0,0,450, 240), file("background.jpg"), shape("round")
...
; send note
	...
	;print inote, ivel, ichn
         		OSCsend     1, "127.0.0.1",8910, "/vectorHarmonizerNote", "iii", inote, ivel, ichn
			event_i "i", (iM_instr+ifracinstrt), 0, -1, inote, ivel, ichn
			;print itime
			xtratim 1/kr
	krelease	release
	if krelease > 0 then
         		OSCsend     1, "127.0.0.1",8910, "/vectorHarmonizerNote", "iii", inote, 0, ichn
...
krepeatScore	chnget "repeatScore"
          		...
          		OSCsend     kplay1, "127.0.0.1",8910, "/vectorHarmonizerControl/play1", "f", kplay1
          		OSCsend     kplay2, "127.0.0.1",8910, "/vectorHarmonizerControl/play2", "f", kplay2
          		OSCsend     kplay3, "127.0.0.1",8910, "/vectorHarmonizerControl/play3", "f", kplay3
          		OSCsend     kplay4, "127.0.0.1",8910, "/vectorHarmonizerControl/play4", "f", kplay4
          		OSCsend     kplay5, "127.0.0.1",8910, "/vectorHarmonizerControl/play5", "f", kplay5
          		OSCsend     krecord1, "127.0.0.1",8910, "/vectorHarmonizerControl/record1", "f", krecord1
          		OSCsend     krecord2, "127.0.0.1",8910, "/vectorHarmonizerControl/record2", "f", krecord2
          		OSCsend     krecord3, "127.0.0.1",8910, "/vectorHarmonizerControl/record3", "f", krecord3
          		OSCsend     krecord4, "127.0.0.1",8910, "/vectorHarmonizerControl/record4", "f", krecord4
          		OSCsend     krecord5, "127.0.0.1",8910, "/vectorHarmonizerControl/record5", "f", krecord5
          		OSCsend     kauto_vRange, "127.0.0.1",8910, "/vectorHarmonizerControl/auto_vRange", "f", kauto_vRange
          		OSCsend     kvRangeBorder, "127.0.0.1",8910, "/vectorHarmonizerControl/kvRangeBorder", "f", kvRangeBorder 
          		OSCsend     kvRangeMin, "127.0.0.1",8910, "/vectorHarmonizerControl/kvRangeMin", "f", kvRangeMin	  
          		OSCsend     kvRangeMax, "127.0.0.1",8910, "/vectorHarmonizerControl/kvRangeMax", "f", kvRangeMax	  
          		OSCsend     krthresh, "127.0.0.1",8910, "/vectorHarmonizerControl/krthresh", "f", krthresh	  
          		OSCsend     kvRangeScore, "127.0.0.1",8910, "/vectorHarmonizerControl/kvRangeScore", "f", kvRangeScore  
          		OSCsend     kgravityScore, "127.0.0.1",8910, "/vectorHarmonizerControl/kgravityScore", "f", kgravityScore 
          		OSCsend     kcommonScore, "127.0.0.1",8910, "/vectorHarmonizerControl/kcommonScore", "f", kcommonScore  
          		OSCsend     kdistanceScore, "127.0.0.1",8910, "/vectorHarmonizerControl/kdistanceScore", "f", kdistanceScore
          		OSCsend     kparallelScore, "127.0.0.1",8910, "/vectorHarmonizerControl/kparallelScore", "f", kparallelScore
          		OSCsend     kspreadScore, "127.0.0.1",8910, "/vectorHarmonizerControl/kspreadScore", "f", kspreadScore  
          		OSCsend     ktoggleScore, "127.0.0.1",8910, "/vectorHarmonizerControl/ktoggleScore", "f", ktoggleScore  
          		OSCsend     krepeatScore, "127.0.0.1",8910, "/vectorHarmonizerControl/krepeatScore", "f", krepeatScore  
	endin
